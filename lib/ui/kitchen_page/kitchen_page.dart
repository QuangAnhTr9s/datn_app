...
import 'package:demo_app/ui/kitchen_page/kitchen_page_bloc.dart';
...
class _KitchenPageState extends State<KitchenPage>
  ...
  final _kitchenPageBloc = KitchenPageBloc();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Phòng bếp', style: TextStyle(color: Colors.white, fontSize: 25),),
        centerTitle: true,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //cảnh báo khí gas
                  FutureBuilder(
                    future: _kitchenPageBloc.getDataDevice("GAS"),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  //button light
                  FutureBuilder(
                    future: _kitchenPageBloc.getDataDevice("Relay/RL3"),
                    builder: (context, snapshot) {
                      final onLight = snapshot.data ?? false;
                      return StreamBuilder<bool>(
                          stream: _kitchenPageBloc.lightStream,
                          builder: (context, snapshot) {
                            ...
                            return MyBoxButton(
                              ...
                              height: 170,
                              onTap:
                              _kitchenPageBloc.handleClickLightButton,
